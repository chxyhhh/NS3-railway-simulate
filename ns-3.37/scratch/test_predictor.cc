...
int main() {
    ...
    predictor->SetPredictionAlgorithm(HandoverPredictor::HYBRID);
    predictor->SetRsrpThreshold(-95.0);
    predictor->SetConfidenceThreshold(0.5);
    ...
    cout << "\n==========预测结果==========" << endl;
    cout << "会切换: " << (result.willHandover ? "是" : "否") << endl;
    cout << "置信度: " << result.confidence << endl;
    cout << "目标小区: " << result.targetCellId << endl;
    cout << "预测时间: " << result.predictedTime.GetSeconds() << "s" << endl;
    cout << "原因: " << result.reason << endl;
